    ...
    <section className="inventory-detail">
      <div className="inventory-detail__header">
        <div className="inventory-detail__title-wrap">
          <button onClick={handleBack} className="inventory-detail__back-button" aria-label="Go back"></button>
          <h1>{item_name}</h1>
        </div>
        <button onClick={handleEdit} className="inventory-detail__edit-button" aria-label="Edit inventory details">
