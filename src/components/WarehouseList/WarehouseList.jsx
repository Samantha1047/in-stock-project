    ...
    <section className="warehouse-list">
      <div className="warehouse-list__header">
        ...
        <div>
          ...
          <button onClick={() => navigate(`/add`)} className="warehouse-list__button">
            + Add New Warehouse
          </button>
        </div>
      </div>
      <div className="warehouse-list__table">
        ...
        <div>
          {warehouseList.map((item) => {
            const { warehouseId, warehouse_name, address, city, country, contact_name, contact_phone, contact_email } = item;
            return (
                ...
                <div className="warehouse-list__information">
                  <div className="warehouse-list__table-cell--left">
                    <div className="warehouse-list__table-cell warehouse-list__table-cell--tablet">
                      ...
                      <Link to={`${warehouseId}`} className="warehouse-list__link">
                        <p> {warehouse_name}</p>
